...
int PacketDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "header") == 0)
        return baseIndex + 0;
    if (strcmp(fieldName, "payload") == 0)
        return baseIndex + 1;
    if (strcmp(fieldName, "trailer") == 0)
        return baseIndex + 2;
    if (strcmp(fieldName, "frame_type") == 0)
        return baseIndex + 3;
    if (strcmp(fieldName, "ACK_nr") == 0)
        return baseIndex + 4;
...
int PacketDescriptor::getFieldArraySize(omnetpp::any_ptr object, int field) const
{
    ...
    Packet_Base *pp = omnetpp::fromAnyPtr<Packet_Base>(object);
    (void)pp;
    switch (field)
    {
    default:
...
void PacketDescriptor::setFieldArraySize(omnetpp::any_ptr object, int field, int size) const
{
    ...
    {
    default:
        throw omnetpp::cRuntimeError("Cannot set array size of field %d of class 'Packet_Base'", field);
    }
}
...
std::string PacketDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    {
    case FIELD_header:
        return long2string(pp->getHeader());
    case FIELD_payload:
        return oppstring2string(pp->getPayload());
    case FIELD_trailer:
        return long2string(pp->getTrailer());
    case FIELD_frame_type:
        return long2string(pp->getFrame_type());
    case FIELD_ACK_nr:
        return long2string(pp->getACK_nr());
    default:
        return "";
    }
}
...
void PacketDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    {
    case FIELD_header:
        pp->setHeader(string2long(value));
        break;
    case FIELD_payload:
        pp->setPayload((value));
        break;
    case FIELD_trailer:
        ...
        break;
    case FIELD_frame_type:
        pp->setFrame_type(string2long(value));
        break;
    case FIELD_ACK_nr:
        pp->setACK_nr(string2long(value));
        break;
    default:
        throw omnetpp::cRuntimeError("Cannot set field %d of class 'Packet_Base'", field);
    }
}
...
omnetpp::cValue PacketDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    case FIELD_trailer:
        return pp->getTrailer();
    case FIELD_frame_type:
        return pp->getFrame_type();
    case FIELD_ACK_nr:
        return pp->getACK_nr();
    default:
        throw omnetpp::cRuntimeError("Cannot return field %d of class 'Packet_Base' as cValue -- field index out of range?", field);
    }
}
...
void PacketDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue &value) const
{
    ...
    {
    case FIELD_header:
        pp->setHeader(omnetpp::checked_int_cast<int>(value.intValue()));
        break;
    case FIELD_payload:
        pp->setPayload(value.stringValue());
        break;
    case FIELD_trailer:
        pp->setTrailer(omnetpp::checked_int_cast<char>(value.intValue()));
        break;
    case FIELD_frame_type:
        pp->setFrame_type(omnetpp::checked_int_cast<short>(value.intValue()));
        break;
    case FIELD_ACK_nr:
        pp->setACK_nr(omnetpp::checked_int_cast<int>(value.intValue()));
        break;
    default:
        throw omnetpp::cRuntimeError("Cannot set field %d of class 'Packet_Base'", field);
    }
